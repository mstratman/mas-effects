...
window.addEventListener('load', function () {
  var app = new Vue({
    ...
    data: {
      ...
      stickers: [
        { key: 'monster', artist: 'Kailey Reid', title: 'Hiding Fear', url: 'https://www.instagram.com/kaileyreidillustration/', note: "Optional add-on: Eyes glow red. (step 3)", addon: "Glowing eyes", addonPrice: 10 },
        { key: 'spaceman', artist: 'David Slebodnick', title: 'Hiding Fear', url: 'https://www.instagram.com/daviddrawsdrawings/', note: "Optional add-on: Eyes glow red. (step 3)", addon: "Glowing eyes", addonPrice: 10 },
        ...
        { key: 'isolation', artist: 'Justin Estcourt', title: 'Isolation', url: 'https://www.instagram.com/jetsyart/', note: "Staff glows blue. Optional Add-on (step 3)", addon: "Glowing staff", addonPrice: 10 },
